...
start() -> 
    connect("0.0.0.0", 2223, "AsDT67aQ", "general", "joe").


test() ->
    connect("0.0.0.0", 2223, "AsDT67aQ", "general", "joe"),
    connect("0.0.0.0", 2223, "AsDT67aQ", "general", "jane"),
    connect("0.0.0.0", 2223, "AsDT67aQ", "general", "jim"),
    connect("0.0.0.0", 2223, "AsDT67aQ", "general", "sue").
